...
public class Enemy extends MovingGameObject {
    ...
    ImageIcon alien1 = new ImageIcon("images/alienSkinI.gif");
    ImageIcon alien2 = new ImageIcon("images/alienSkinII.gif");
    ImageIcon alien3 = new ImageIcon("images/alienSkinIII.gif");
    ImageIcon alienBoss = new ImageIcon("images/bossI.gif");
    ImageIcon alienBoss2 = new ImageIcon("images/bossII.gif");
    ImageIcon alienBoss3 = new ImageIcon("images/bossIII.gif");
